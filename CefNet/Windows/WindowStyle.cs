...
namespace CefNet.WinApi
{
	...
	public enum WindowStyle
	{
		...
		/// control with the WS_GROUP style.
		/// The first control in each group usually has the WS_TABSTOP style so that
		/// the user can move from group to group. The user can subsequently change
		/// the keyboard focus from one control in the group to the next control in
		...
		/// <summary>
		/// The window is an overlapped window. An overlapped window
		/// has a title bar and a border.
		/// </summary>
		WS_OVERLAPPED = 0x0,
		...
		/// <summary>
		/// The window is a pop-up window. This style cannot be used
		...
		/// the next control with the WS_TABSTOP style. You can turn this style on and
		/// off to change dialog box navigation. To change this style after a window
		/// has been created, use the SetWindowLong function.
		...
		/// <summary>
		/// The window is initially visible. This style can be turned on and off by using
